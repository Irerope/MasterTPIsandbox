...
$string['trad9_FormatDate'] = 'Today is ".strftime("%A, %d of %B, %Y",$a->rawTime)." and the week begins.';
...
$string['trad9_Message'] = 'It could have been done by anyone, but Mr. $a->user_surname achieved it again. Â¡Hurrah $a->user_name $a->user_surname!';
